...
Prompt: |
  ...
  2. Read /workspace/agent/grocery/delivery-log.md to find which orders are already processed
...
Prompt: |
  ...
  1. Read /workspace/agent/grocery/fridge-state.md for the last known state
  2. Read /workspace/agent/grocery/delivery-log.md for recent deliveries
  3. Read /workspace/agent/grocery/household.md for household size (default: 2 adults if missing)
  ...
  6. Update /workspace/agent/grocery/fridge-state.md with current estimates
...
Prompt: |
  ...
  1. Read /workspace/agent/grocery/preferences.md for taste profile and brand preferences
  2. Read /workspace/agent/grocery/staples.md for always-buy items
  3. Read /workspace/agent/grocery/patterns.md for seasonal preferences
...
Check `/workspace/agent/grocery/household.md`. If missing or incomplete, ask:
...
If `/workspace/agent/grocery/` doesn't exist or is mostly empty:
