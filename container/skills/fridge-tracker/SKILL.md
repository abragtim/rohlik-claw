...
Maintain an estimated view of what the household currently has at home, based on delivery history and category-based consumption rates. The state is stored in `/workspace/agent/grocery/fridge-state.md`.
...
Read `/workspace/agent/grocery/fridge-state.md`. If it doesn't exist, build it from the most recent delivery.
